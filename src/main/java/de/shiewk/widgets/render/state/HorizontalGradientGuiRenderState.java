...
public final class HorizontalGradientGuiRenderState implements SimpleGuiElementRenderState {
    ...
    public void setupVertices(VertexConsumer vertices, float depth) {
        vertices.vertex(pose, x, y, depth).color(colorLeft);
        vertices.vertex(pose, x, endY, depth).color(colorLeft);
        vertices.vertex(pose, endX, endY, depth).color(colorRight);
        vertices.vertex(pose, endX, y, depth).color(colorRight);
    }
